...
class SQLAlchemyCRUDRouter(CRUDGenerator[SCHEMA]):
    ...
    def _get_all(self, *args: Any, **kwargs: Any) -> CALLABLE_LIST:
        ...
        def route(
            ...
            db_models: List[Model] = (db.query(self.db_model).order_by(
...
class SQLAlchemyAsyncCRUDRouter(CRUDGenerator[SCHEMA]):
    ...
    def __init__(self,
        ...
        assert (
            sqlalchemy_installed
        ), "SQLAlchemy must be installed to use the SQLAlchemyAsyncCRUDRouter."
